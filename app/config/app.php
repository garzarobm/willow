...
return [
    ...
    'Log' => [
        ...
        'debug_file' => [
            ...
            'path' => env('LOG_DEBUG_PATH', LOGS),
            'file' => env('LOG_DEBUG_FILE', 'debug'),
            'url' => env('LOG_DEBUG_URL', null),
            'scopes' => null,
            'levels' => explode(',', env('LOG_DEBUG_LEVELS', 'notice,info,debug')),
        ],
        'error_file' => [
            'className' => FileLog::class,
            'path' => env('LOG_ERROR_PATH', LOGS),
            'file' => env('LOG_ERROR_FILE', 'error'),
            'url' => env('LOG_ERROR_URL', null),
            'scopes' => null,
            'levels' => explode(',', env('LOG_ERROR_LEVELS', 'warning,error,critical,alert,emergency')),
        ],
        // To enable this dedicated query log, you need set your datasource's log flag to true
        'queries' => [
            'className' => FileLog::class,
            'path' => env('LOG_QUERIES_PATH', LOGS),
        ...
        'admin_actions' => [
            'className' => FileLog::class,
            'path' => env('LOG_ADMIN_ACTIONS_PATH', LOGS),
            'file' => env('LOG_ADMIN_ACTIONS_FILE', 'bulk_actions'),
            'levels' => ['info'],
