...
<html lang="<?= $this->request->getParam('lang', 'en') ?>" data-bs-theme="auto">
  ...
  <?php if (!empty($consentData) && $consentData['analytics_consent']) :?>
    ...
    <?= $this->element('site/meta_tags', ['model' => $product ?? $tag ?? null]) ?>
    ...
    <?= $this->Html->meta([
        ...
        'title' => __('Latest Products RSS Feed'),
        'rel' => 'alternate'
    ]); ?>
</head>
  <body>
    ...
    <main class="container" id="main-content">
      <div class="row g-5">
        ...
        <div class="col-lg-8">
            <div role="main" aria-label="<?= __('Product list') ?>">
                <?= $this->Flash->render() ?>
                <?= $this->fetch('content') ?>
                <?= $this->element('pagination', ['recordCount' => count($products)]) ?>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="p-4 mb-3 bg-body-tertiary rounded">
              ...
              <p class="mb-0"><?= __("Welcome to willowcms.app. This site uses Willow - a content management system I'm building in the open. Here you'll find development updates, feature highlights, and guides on using Willow for your own sites.") ?></p>
                ...
                <?= $this->element('site/products_list', ['products' => $featuredProducts, 'title' => __('Featured posts')]) ?>

                <?= $this->element('site/products_list', ['products' => $recentProducts, 'title' => __('Recent posts')]) ?>
